...
<head>
  ...
  <script>
    ...
    if (AMp == 12 && getAmVar == 'am') {
      ...
      document.querySelector('#headThis').innerHTML = `<link rel="stylesheet" href="assets/css/records-dark.css">`
    } else if (AMp == 12 && getAmVar == 'pm') {
      console.log('hours =>', AMp, 'Am/Pm =>', getAmVar)
      document.querySelector('#headThis').innerHTML = `<link rel="stylesheet" href="assets/css/records.css">`
